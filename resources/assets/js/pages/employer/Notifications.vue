                    ...
                    <div class="Day-lists" v-if="Object.keys(notifications).length > 0">
                        <div class="Day-item" v-for="(dayNotification,key) in notifications">
                            ...
                            <div class="Notifications-lists">
                                <EmployerNotificationList v-for="notification in dayNotification" :notification="notification"></EmployerNotificationList>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    import EmployerNotificationList from '../../components/notifications/EmployerNotificationList.vue';
    import CornerButtons from '../../components/common/CornerButtons.vue';
    import * as types from '../../store/mutation-types'
    import {mapState} from 'vuex'
    export default {
        name:'EmployerNotifications',
        components:{Navbar,SideNav,EmployerNotificationList,CornerButtons},
        data() {
            return {
                notifications:[],
            };
